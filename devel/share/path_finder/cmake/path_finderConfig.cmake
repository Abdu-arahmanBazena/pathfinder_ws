...
if(NOT "/home/abdo/pathfinder_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'path_finder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/abdo/pathfinder_ws/src/path_finder/${idir}'.  ${_report}")
    endif()
